...
{
    [TestClass]
    public class ReuseEntityRepositoryWithJournalTests
    {
        ...
        [TestMethod]
        public void Mongo_ReuseCollection_WithJournal_RunEntity_Single()
        {
            RunEntity();
        ...
        [TestMethod]
        public void Mongo_ReuseCollection_WithJournal_RunEntity_1000_at_100()
        {
            RunBatch(100, 10);
        }

        [TestMethod]
        public void Mongo_ReuseCollection_WithJournal_RunEntity_10000_at_100()
        {
            RunBatch(100, 100);
        }
        ...
        private void RunEntity()
        {
            ...
            if (!parentRepository.Exists(correlationId))
            {
                ...
                parentRepository.Save(parent, _writeConcern);
            }
        ...
        private void AddEvent(ObjectId id, int statusCode, MongoCollection<Entity> collection)
        {
            ...
            collection.Save(entity, _writeConcern);
        }
    }
}
