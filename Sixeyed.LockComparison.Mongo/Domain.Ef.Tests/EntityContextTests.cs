...
namespace Domain.Ef.Tests
{
    ...
    public class EntityContextTests
    {
        ...
        [TestMethod]
        public void Sql_RunEntity_Single()
        {
            RunEntity();
            using (var context = new EntityContext())
            {
        ...
        [TestMethod]
        public void Sql_RunEntity_1000_at_100()
        {
            RunBatch(100, 10);
        }

        [TestMethod]
        public void Sql_RunEntity_10000_at_100()
        {
            RunBatch(100, 100);
        }
