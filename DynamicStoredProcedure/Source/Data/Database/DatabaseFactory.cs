...
namespace DynamicSP.Data.Database
{
    /// <summary>
    ...
    public static class DatabaseFactory
    {
        ...
        private static string GetConnectionString(string databaseName)
        {
            ...
            {
                throw new ConfigurationErrorsException(string.Format("DatabaseName: {0} not specified in configuration connection strings", databaseName));
            }
